...
public class MainActivity extends AppCompatActivity {
    ...
    private Button sCounterBtn; //define second counter button variable
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sCounterBtn = findViewById(R.id.second_counter_btn);//link to second counter button
        ...
        /* click listener on counter button pressed */
        sCounterBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                /* when counter button is pressed, use intent to switch to Counter Activity */
                Intent intent2 = new Intent(MainActivity.this, CounterPlusTwoActivity.class);
