...
public class AuctionItemObject {
    Uri picture1;
    Uri picture2;
    Uri picture3;
    Uri picture4;
    ...
    int userID;
    int postID;
    public AuctionItemObject(Uri picture1, Uri picture2, Uri picture3, Uri picture4, Uri picture5, Uri picture6, String title, int price, String date, String category, Boolean auction, int flagCount, String description, int userID, int postID) {
