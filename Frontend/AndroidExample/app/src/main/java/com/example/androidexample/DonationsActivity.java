...
import com.example.androidexample.Donation.DonationAdapter;
import com.example.androidexample.Donation.DonationItemObject;
//import com.example.androidexample.Donation.DonationAdapter;
//import com.example.androidexample.Donation.DonationItemObject;
...
public class DonationsActivity extends AppCompatActivity {
     ...
     */
    private DonationAdapter mPostAdapter;
    private RecyclerView mRecyclerView;
    ArrayList<DonationItemObject> mPostList = new ArrayList<>();
...
//    String server_url_list = "http://coms-309-060.class.las.iastate.edu:8080/announcements";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        builder = new AlertDialog.Builder(DonationsActivity.this);
...
//        });
        ...
        mPostAdapter = new DonationAdapter(mPostList, new DonationAdapter.OnItemClickListener() {
            @Override public void onItemClick(DonationItemObject item) {
                Log.d("Hi"," Bye");
                ...
                response -> {
                    try {
                        ...
                        for (int i = jsonArray.length()-1; i >= 0; i--) {
                            ...
                            mPostList.add(new DonationItemObject(picture1,picture2,picture3,picture4,picture5,picture6,title,price,auction, description,userName,id));
                        }
