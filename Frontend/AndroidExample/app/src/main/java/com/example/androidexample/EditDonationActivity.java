...
//    private String encodedString;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_donation);            // link to Login activity XML
...
//        image6 = findViewById(R.id.imageSelView6);
        ...
        t.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view){
                Intent intent = new Intent(EditDonationActivity.this, PostDetailActivity.class);
...
//                });
        ...
        postBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                savePost();
                Intent intent = new Intent(EditDonationActivity.this, MainFeed.class);
                startActivity(intent);
    ...
    private void sendImageToServer(int postId, int imageIndexStartFrom1){
        ...
        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.POST, "http://coms-309-060.class.las.iastate.edu:8080/posts/update", jo , response -> {
            ...
            if (createPostSuccess) {
                Toast.makeText(EditDonationActivity.this, "Post is successful!", Toast.LENGTH_LONG).show();
                //Intent intent = new Intent(CreatePostActivity.this, MainFeed.class);


                //startActivity(intent);
            }else{
                Toast.makeText(EditDonationActivity.this, "Post unsuccessful.", Toast.LENGTH_LONG).show();
            }
